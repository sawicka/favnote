...
export const REMOVE_ITEM_REQUEST = 'REMOVE_ITEM_RREQUEST';
...
export const removeItem = (itemType, id) => (dispatch) => {
  ...
  return axios
    .delete(`http://localhost:9001/api/note/${id}`)
    .then(() => {
      dispatch({
...
export const addItem = (itemType, itemContent) => (dispatch, getState) => {
  ...
  return axios
    .post('http://localhost:9001/api/note', {
...
export const fetchItems = (itemType) => (dispatch, getState) => {
  ...
  return axios
    .get('http://localhost:9001/api/notes/type', {
      params: {
        type: itemType,
        userID: getState().userID,
      },
